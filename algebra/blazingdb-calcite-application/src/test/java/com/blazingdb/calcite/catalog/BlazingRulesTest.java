	...
	createTableSchemas() throws Exception {
		...
		map.put("customer",
			Arrays.asList(new SimpleEntry<>("c_custkey", CatalogColumnDataType.INT32),
				...
				new SimpleEntry<>("c_acctbal", CatalogColumnDataType.DOUBLE),
		...
		map.put("orders",
			Arrays.asList(new SimpleEntry<>("o_orderkey", CatalogColumnDataType.INT64),
				...
				new SimpleEntry<>("o_totalprice", CatalogColumnDataType.DOUBLE),
				new SimpleEntry<>("o_orderdate", CatalogColumnDataType.TIMESTAMP),
		...
		map.put("supplier",
			Arrays.asList(new SimpleEntry<>("s_suppkey", CatalogColumnDataType.INT64),
				...
				new SimpleEntry<>("s_acctbal", CatalogColumnDataType.DOUBLE),
		...
		map.put("lineitem",
			Arrays.asList(new SimpleEntry<>("l_orderkey", CatalogColumnDataType.INT64),
				...
				new SimpleEntry<>("l_quantity", CatalogColumnDataType.DOUBLE),
				new SimpleEntry<>("l_extendedprice", CatalogColumnDataType.DOUBLE),
				new SimpleEntry<>("l_discount", CatalogColumnDataType.DOUBLE),
				new SimpleEntry<>("l_tax", CatalogColumnDataType.DOUBLE),
				new SimpleEntry<>("l_returnflag", CatalogColumnDataType.STRING),
				new SimpleEntry<>("l_linestatus", CatalogColumnDataType.STRING),
				new SimpleEntry<>("l_shipdate", CatalogColumnDataType.TIMESTAMP),
				new SimpleEntry<>("l_commitdate", CatalogColumnDataType.TIMESTAMP),
				new SimpleEntry<>("l_receiptdate", CatalogColumnDataType.TIMESTAMP),
		...
		map.put("part",
			Arrays.asList(new SimpleEntry<>("p_partkey", CatalogColumnDataType.INT64),
				...
				new SimpleEntry<>("p_retailprice", CatalogColumnDataType.FLOAT),
		...
		map.put("partsupp",
			Arrays.asList(new SimpleEntry<>("ps_partkey", CatalogColumnDataType.INT64),
				...
				new SimpleEntry<>("ps_supplycost", CatalogColumnDataType.FLOAT),
