...
conda install --yes -c conda-forge spdlog=1.7.0 google-cloud-cpp=1.25 ninja mysql-connector-cpp=8.0.23 libpq=13 nlohmann_json=3.9.1 unixodbc=2.3.9
...
pip install openpyxl pymysql gitpython pynvml gspread oauth2client snowflake-connector-python==2.4.2
