...
gdf_data_provider::gdf_data_provider(std::vector<std::shared_ptr<ral::frame::BlazingCudfTableView>> table_views, std::vector< std::map<std::string,std::string> > column_values)
