 ...
 */
class ArrowCacheDataLocalFile : public CacheData {
 public:
  /**
	* Constructor
   ...
   */
  ArrowCacheDataLocalFile(std::unique_ptr<ral::frame::BlazingTable> table,
  ...
  /**
	* Destructor
   */
  virtual ~ArrowCacheDataLocalFile() {}
 ...
 private:
  std::vector<std::string>
      col_names;         /**< The names of the columns, extracted from the ORC file. */
