...
std::tuple<std::shared_ptr<CacheMachine>, std::shared_ptr<CacheMachine>> register_kernel_with_cache_machines(
	...
	std::shared_ptr<CacheMachine>  inputCacheMachine = ral::cache::CacheMachine::make_single_machine(context, "");
	std::shared_ptr<CacheMachine> outputCacheMachine = ral::cache::CacheMachine::make_single_machine(context, "");
